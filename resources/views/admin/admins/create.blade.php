            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 pd-less">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            {{ Form::text('name', (isset($objData) && !empty($objData) && is_object($objData) && !empty($objData->stripe_sk) ? $objData->username : ''), ['class' => 'form-control user', 'placeholder' => 'Name']) }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 pd-none">
                            ...
                            {{ Form::email('email', (!empty($objData) && is_object($objData) && !empty($objData->admin_email) ? $objData->admin_email : ''), ['class' => 'form-control user', 'placeholder' => 'Enter your email address']) }}
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-12 mr_btm pd-none"><strong>Password </strong></div>
                        <div class="col-md-6 col-sm-6 col-xs-12 pd-none">

                            {!! Form::password('password', ['class' => 'form-control lock', 'id' => 'passwords', 'placeholder' => '']) !!}
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-12 mr_btm pd-none"><strong>Confirm Password </strong></div>
                        <div class="col-md-6 col-sm-6 col-xs-12 pd-none">

                            {!! Form::password('password_confirmation', ['class' => 'form-control lock', 'id' => 'passwords', 'placeholder' => '']) !!}
