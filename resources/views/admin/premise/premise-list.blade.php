                ...
                @include('common.admin.flash-message')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3  col-md-4 col-xs-6 col-sm-4 pd-btn full-wid2">  
                            ...
                            <a href="{{url('/admin/premise')}}" class="btn btn-default">Reset</a>
                        </div>
                        ...
                        {!!
                            ...
                            <button type="submit" class="btn btn-default cr_btn">Create Building</button>
                    ...
                    <table class="table table-bordered  table-condensed" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th>@sortablelink('name', 'Building Name')</th>
                        ...
                        <tbody>
                            ...
                            <tr class="trCate">
                                ...
                                <td>
                                    <span class="label label-{{ $label }} sts" style="cursor: pointer;" data-sts="{{ $sts }}" title="click to make {{ $sts }}"  data-id="{{ !empty($var) && is_object($var) && !empty($var->id) ? $encryptId : '' }}" data-type="premise">{{ $status }}</span>
                                </td>
                                
                                <td class="actions center btn-2 action-center">
                                    <div class="btn-group">
                                    <a href="{{ route('premise.edit', ['id' => $encryptId]) }}" class="btn btn-primary btn-xs" title="Edit">
                            ...
                            {!!
                                ...
                                'url' => 'admin/premise/'.(!empty($var) && is_object($var) && !empty($var->id) ? $encryptId : ''),
                                'autocomplete' => 'off',
                                'class' => 'form-horizontal',
                                'style' => 'display:none',
                                'files' => false
